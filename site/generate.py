...
<li>Modifications publiées sous 72 h ouvrées · résiliation en 1 clic · support par email en 24 h ouvrées</li>
...
<p>La mise en ligne du contenu enrichi intervient après validation du paiement, dans un délai maximum de 72 heures ouvrées (le site étant régénéré par lots deux fois par semaine, les lundis et jeudis).</p>
