...
<li>Modifications publiées sous 48 h ouvrées · résiliation en 1 clic · support par email en 24 h ouvrées</li>
...
<p>La mise en ligne du contenu enrichi intervient après validation du paiement, dans un délai maximum de 48 heures ouvrées (le site étant régénéré par lots deux fois par semaine, les lundis et jeudis).</p>
...
<p>À l'expiration, la fiche revient à sa version socle gratuite (données officielles seules), au plus tard 48 heures ouvrées après l'échéance — le site étant régénéré par lots, le contenu enrichi peut rester visible quelques jours de plus sans que cela ouvre droit à facturation. Le contenu saisi est conservé pendant 6 mois et redevient immédiatement publiable en cas de réabonnement.</p>
